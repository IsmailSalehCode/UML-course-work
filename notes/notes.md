...
Причината да е използвана стрелка за композиция от ContractEvent към PSC, от Alert към PSC, от MaintenanceEvent към Device: Обект от детския клас не може да съществува без наличието на обект от родителския клас.

Причината да е използвана стрелка за агрегация от Device към Location, от Location към PSC: Обект от детския клас може да съществува независимо от съществуването на обект от родителския му клас.
