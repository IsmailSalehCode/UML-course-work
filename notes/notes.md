...
`Use case` диаграма - на диаграмата са представени видовете действия, които персоналът на охранителната система може да извършва. Охранителят може да се логва в системата и след това да я деактивира/активира, да избира охраняема локация, да разглежда статуса на инстралираните там устройства, да разглежда историята на поддръжката им, да наблюдава поточен кадър от наличните камери и т.н.
